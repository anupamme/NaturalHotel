...
//    this.picker = jQuery("<ul id='carousel' class='thumbnails image_picker_selector '></ul>");
  ...
  ImagePickerOption = (function() {
    ...
    ImagePickerOption.prototype.create_node = function() {
      var image, thumbnail;
      this.node = jQuery("<li/>");
        //this.node.attr('padding-left', '10px')
      image = jQuery("<img class='image_picker_image'/>")
      image.attr("src", this.option.data("img-src"))
      image.attr('height', '164px')
      image.attr('width', '154px')
      //image.attr('padding-left', '10px')

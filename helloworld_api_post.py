...
class HelloWorldApi2(remote.Service):
    ...
    def greetings_multiply(self, request):
        return Greeting(message= request.purpose + ';' + request.location + ';' + ','.join(request.food))
        #return Greeting(message = request.purpose + ';' + request.location )
...
APPLICATION = endpoints.api_server([HelloWorldApi2])